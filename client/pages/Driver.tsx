...
export default function Driver() {
  ...
  const drivingModes = [
    { id: "standard", name: "Standard", description: "Regular rides, all vehicle types", icon: Car },
    { id: "premium", name: "Premium Only", description: "High-end rides, premium vehicles", icon: Star },
    { id: "eco", name: "Eco Mode", description: "Short rides, fuel efficient", icon: Leaf },
    { id: "long", name: "Long Distance", description: "Airport & intercity rides", icon: Route },
    { id: "night", name: "Night Shift", description: "10PM - 6AM rides", icon: Clock },
    { id: "pool", name: "Pool Focus", description: "Shared rides priority", icon: Users },
  ];
    ...
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="container py-8 relative z-10">
        ...
        >
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <Card className="glass">
                    <CardContent className="p-4 text-center">
                      <div className="text-2xl font-bold text-driver">${todayEarnings}</div>
                ...
                <Card className="glass">
                  <CardHeader className="pb-3">
                    <CardTitle className="text-lg text-gradient">Driving Mode</CardTitle>
                  </CardHeader>
                  <CardContent className="space-y-3">
                    <div className="grid grid-cols-1 gap-2">
                      {drivingModes.slice(0, 3).map((mode) => (
                        <Button
                          key={mode.id}
                          variant={drivingMode === mode.id ? "default" : "outline"}
                          size="sm"
                ...
                <Card className="glass">
                  ...
                  <CardContent>
                    <div className="text-center">
                      <div className="text-3xl font-bold text-green-500">{safetyScore}</div>
          ...
          {/* Onboarding & KYC Tab */}
          <TabsContent value="onboarding" className="space-y-6 animate-fade-in-up">
            <Card className="glass">
              <CardHeader>
                <CardTitle className="flex items-center text-gradient">
                ...
                <div className="flex items-center justify-between p-4 rounded-lg border glass">
                  <div className="flex items-center space-x-3">
                    <div className={`p-2 rounded-full ${
                      ...
                      kycStatus === 'pending' ? 'bg-yellow-500/20' : 'bg-red-500/20'
                    }`}>
                      {kycStatus === 'verified' ? (
          ...
          <TabsContent value="earnings" className="space-y-6 animate-fade-in-up">
            <div className="grid lg:grid-cols-3 gap-6">
              ...
              <div className="lg:col-span-2 space-y-6">
                ...
                <Card className="glass">
                  <CardHeader>
                    <CardTitle className="text-gradient">Earnings Dashboard</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="grid grid-cols-3 gap-6">
                      <div className="text-center">
                        <div className="text-3xl font-bold text-driver">${todayEarnings}</div>
                        <div className="text-sm text-muted-foreground">Today</div>
                      </div>
                      <div className="text-center">
                        <div className="text-3xl font-bold text-accent">${weeklyEarnings}</div>
                        <div className="text-sm text-muted-foreground">This Week</div>
                      </div>
                      <div className="text-center">
                        <div className="text-3xl font-bold text-primary">$3,247</div>
                  ...
                  <CardContent className="space-y-4">
                    <div className="space-y-3">
                      ...
                      <div className="flex justify-between">
                        ...
                        <span className="font-medium text-blue-600">+$8.75</span>
                      </div>
                      <div className="flex justify-between">
                        <span>EV Bonus</span>
                        <span className="font-medium text-green-600">+$5.25</span>
                      </div>
                  ...
                  <CardContent className="space-y-3">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <div className="text-sm text-muted-foreground">Auto-withdraw</div>
                      </div>
                    </div>
                  ...
                  <CardContent>
                    <div className="space-y-3">
                      <div className="flex justify-between">
                        ...
                        <span className="text-sm">${weeklyEarnings} / $1,000</span>
                      </div>
                ...
                <Card className="glass">
                  ...
                  <CardContent className="space-y-3">
                    <div className="p-3 rounded-lg bg-green-500/10 border border-green-500/20">
                      <div className="font-medium text-green-600">Peak Hours</div>
                      <div className="text-sm text-muted-foreground">+25% (6-9 PM)</div>
                    </div>
                    <div className="p-3 rounded-lg bg-blue-500/10 border border-blue-500/20">
                      <div className="font-medium text-blue-600">Weekend Bonus</div>
                      <div className="text-sm text-muted-foreground">+15% all weekend</div>
                    </div>
                  </CardContent>
                </Card>
              </div>
            ...
            <Card className="glass">
              ...
              <CardContent className="space-y-6">
                ...
                <div className="text-center p-6 rounded-lg glass">
                  <div className="text-4xl font-bold text-green-500 mb-2">{safetyScore}</div>
                  <div className="text-lg font-medium">Safety Score</div>
                  <div className="text-sm text-muted-foreground">Excellent Driver</div>
                  <Progress value={safetyScore} className="mt-4 max-w-xs mx-auto" />
                </div>
                    ...
                    <div className="flex items-center justify-between p-3 rounded-lg border">
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          ...
                          <div className="text-sm text-muted-foreground">24/7 Driver Support</div>
                        </div>
                      </div>
                      <Button size="sm" variant="outline">
                        Call
                ...
                <div className="space-y-3">
                  ...
                  <div className="space-y-2 text-sm text-muted-foreground">
                    ...
                    <div className="flex items-start space-x-2">
                      <CheckCircle className="h-4 w-4 text-green-500 mt-0.5" />
                      <span>Keep doors locked until passenger verification</span>
                    </div>
                    <div className="flex items-start space-x-2">
                      <CheckCircle className="h-4 w-4 text-green-500 mt-0.5" />
                      <span>Trust your instincts - cancel ride if uncomfortable</span>
                    </div>
                    <div className="flex items-start space-x-2">
                      <CheckCircle className="h-4 w-4 text-green-500 mt-0.5" />
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <div className="text-sm text-muted-foreground">Downtown Business District</div>
                      </div>
                    </div>
                  ...
                  {routeSuggestions.map((route, index) => (
                    ...
                    >
                      <div className="flex items-center justify-between mb-3">
                        ...
                        <div className="flex items-center space-x-2">
                          <Badge variant={
                            route.demand === 'High' ? 'default' :
                            route.demand === 'Medium' ? 'secondary' : 'outline'
                          }>
                            {route.demand} Demand
                          </Badge>
                          {route.surge > 1.2 && (
            ...
            <div className="grid lg:grid-cols-2 gap-6">
              ...
              <Card className="glass">
                ...
                <CardContent className="space-y-6">
                  ...
                  {/* EV Points */}
                  <div className="text-center p-6 rounded-lg glass">
                    <div className="text-3xl font-bold text-green-500 mb-2">{evPoints}</div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="grid grid-cols-2 gap-4 text-sm">
                      <div className="text-center p-3 rounded-lg border">
                        <div className="text-xl font-bold text-green-600">47kg</div>
                        <div className="text-muted-foreground">CO₂ Saved</div>
                      </div>
                      <div className="text-center p-3 rounded-lg border">
                        <div className="text-xl font-bold text-blue-600">23L</div>
                ...
                <CardContent className="space-y-4">
                  {evRewards.map((reward, index) => (
                    <div key={index} className="space-y-2">
                      <div className="flex items-center justify-between">
                        <span className="font-medium text-sm">{reward.action}</span>
