...
export default function ScheduledRides() {
  ...
  const scheduleRide = () => {
    ...
    const newRide: ScheduledRide = {
      ...
      vehicleType,
      estimatedFare:
        vehicleTypes.find((v) => v.value === vehicleType)?.price || 25,
      status: "scheduled",
      reminderSet: true,
      ...
      <Card className="glass glow relative overflow-hidden">
        ...
        <CardHeader className="relative z-10">
          <CardTitle className="flex items-center justify-between text-gradient">
            ...
            <Button onClick={() => setShowForm(!showForm)} className="glow">
        ...
        <CardContent className="relative z-10">
          <div className="grid grid-cols-3 gap-4">
            ...
            <div className="text-center glass p-3 rounded-lg">
              ...
              <p className="text-sm font-medium">
                {scheduledRides.filter((r) => r.recurring).length} Recurring
              </p>
            </div>
            <div className="text-center glass p-3 rounded-lg">
                    ...
                    <div className="text-right ml-4">
                      ...
                      <div className="flex space-x-1 mt-2">
                        <Button
                          size="sm"
                          variant="outline"
                          className="h-7 w-7 p-0 glass-hover"
                        >
